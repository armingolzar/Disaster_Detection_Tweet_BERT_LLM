...
class Disaster_Detection_BERT_Model():
    ...
    def building_network():
        ...
        dense3 = Dense(16, activation="relu", name="dense3")(drop3)
    ...
    @staticmethod
    def compil_model(model, optimizer="Adam", learning_rate=1e-3): # for feature extraction use 1e-3 but for fine-tuning we need smaller updates 1e-5
